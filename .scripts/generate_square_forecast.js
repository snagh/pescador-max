...
<svg width="360" height="360" viewBox="0 0 360 360" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="28" y="96" fill="#fbbf24" font-size="13" font-family="Arial, sans-serif">Crescente Côncava • 23% Iluminação</text>
  ...
  <text x="28" y="196" fill="#fbbf24" font-size="13" font-family="Arial, sans-serif">Crescente Côncava • 32% Iluminação</text>
  ...
  <text x="28" y="296" fill="#fbbf24" font-size="13" font-family="Arial, sans-serif">Quarto Crescente • 42% Iluminação</text>
...
async function run() {
  const dest = path.join(outDir, 'square_screenshot_4_forecast.png');
  await sharp(Buffer.from(svgSquareForecast))
    .resize(360, 360)
    .png()
    .toFile(dest);
